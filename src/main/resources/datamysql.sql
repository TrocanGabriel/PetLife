...
INSERT INTO clinics (id,name,address,phone, program_start,program_end) VALUES
  (1, 'Aliko', 'Str Motrului Nr 24', '07054203',TIME('10:00'),TIME('18:00')),
  (2,'Bill', 'Bd Colonel Oancea Nr 12', '020131',TIME('09:00'),TIME('19:00')),
  (3,'Folrunsho', 'Str. Soarelui Nr 13B', '0123231',TIME('10:00'),TIME('20:00'));
